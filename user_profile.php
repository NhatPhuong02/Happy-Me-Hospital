                            ...
                            <div class="row row-cols-1 notibar">
                                <div class="col mt-2 ms-2 p-2 bg-success text-white rounded text-start w-50">
                                    ...
                                    <span class="ms-2 mt-2">Successfully updated your profile! 
                                        <!-- for testing / delete if test done-->
                                        <?php
    echo $_SESSION['test1'] . " ~ " . $_SESSION['test2'] . " ~ " .  $_SESSION['test3'] . " ~ " . $_SESSION['test4'] . " ~ " . $_SESSION['avatar'] . " ~ " . $_SESSION['test5'];
?></span>
<!-- end testing -->
                                    <span class="me-2 float-end"><a class="text-decoration-none link-light" href="user_profile.php">X</a></span>
                                </div>
            ...
            <div class="col-9 ">
                <div class="card bg-main fs-4 text-white w-auto">
                    ...
                    <div class="row ps-0 ms-2 my-3">
                        ...
                        <div class="col-9 data"><?php if (isset($_SESSION['phone'])) {
                    ...
                    <div class="row ps-0 ms-2 my-3">
                        ...
                        <div class="col-9 data"><?php if (isset($_SESSION['gender'])) {
                                                    echo $_SESSION['gender'];
                                                } ?></div>
                    </div>
                    <div class="row ps-0 ms-2 my-3">
                        <div class="col-3 title">Address:</div>
                        <div class="col-9 data "><?php if (isset($_SESSION['address'])) {
